...
describe('Express object defined routes', function () {
  it('basic router from definition', function () {
    const app = express()
    const definition = [
      { path: '/users', method: 'get', callback (req, res) { res.send('res from users') } }
    ]
